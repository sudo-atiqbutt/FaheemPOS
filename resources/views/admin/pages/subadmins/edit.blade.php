	            			...
	            			<div class="col-sm-6">
				                <div class="form-group">
								  ...
								  <select class="form-control" name="admin_type">
								    ...
								    <option value="recruitment_specialist" @if($subadmin[0]['role']=='recruitment_specialist') selected @endif>Recruitment Specialist</option>
								    <option value="sales_officer" @if($subadmin[0]['role']=='sales_officer') selected @endif>Sales Officer</option>
								  </select>
								</div>
				            </div>
		            		<div class="col-sm-6">
				                <div class="form-group">
				                  ...
				                  <div class="input-group">
				                    <input type="text" name="admin_name" value="{{$subadmin[0]['name']}}" class="form-control">
				                  </div>
				                </div>
				            </div>				
		            		<div class="col-sm-6">
				                <div class="form-group">
				                  <label>Email:</label>
				                  <div class="input-group">
				                    <input type="text" name="admin_email" value="{{$subadmin[0]['email']}}" class="form-control">
				                  </div>
				                </div>
				            </div>
		            		<div class="col-sm-6">
